...
async function main() {
    ...
    await transaction.wait()
    balance = await usd.connect(investor2).balanceOf(investor2.address)
    console.log(`Investor 2 approved tokens: ${balance}\n`)    
